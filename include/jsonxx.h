...
public:
    ...
    std::string xml(unsigned format = JSONx, const std::string &header =
            std::string(), const std::string &attrib = std::string()) const;
...
public:
    enum {
        NUMBER_, STRING_, BOOL_, NULL_, ARRAY_, OBJECT_, INVALID_
    } type_;
    union {
